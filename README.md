# CAPSTONE_DATASCIENCE_STARBUCKS
...
- `myportfolio.json` - containing offer ids and meta data about each offer (duration, type, etc.)
- `myprofile.json` - demographic data for each customer
- `mytranscript.json` - records for transactions, offers received, offers viewed, and offers completed
...
The main findings of the code can be found at the post available [here](https://medium.com/@vladyslav.didkovsky/a-starbucks-case-study-optimizing-customer-to-promotion-match-8d9033388404).
